...
const user = { name: "Emmanuel Pallares", age: 25 };

const name = user.name;
const age = user.age;
/*name would have a value of the string Emmanuel Pallares, and age would have the number 25.

Here's an equivalent assignment statement using the ES6 destructuring syntax:*/

const { name, age } = user;

/*Again, name would have a value of the string Emmanuel Pallares, and age would have the number 25.
