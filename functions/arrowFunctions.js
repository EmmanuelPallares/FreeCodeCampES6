...
especially when passing a function as an argument to 
another function. Instead, we create inline functions. 
...
magic which returns a new Date() to use arrow 
function syntax. Also, make sure nothing is 
